...
/**
 * Provides code snippets demonstrating the configuration of Avro serializers
 ...
 * </ul>
 */
public class HowToConfigureAvroSerializerSchemaRegistryConnection {

    /**
     * Demonstrates how to configure an Avro serializer with a Schema Registry endpoint without authentication.
     */
    public static void SerializeWithSchemaRegistryEndpoint() throws IOException {
    ...
    /**
     * Demonstrates how to configure an Avro serializer with an authenticated Schema Registry endpoint.
     */
    public static void SerializeWithAuthenticatedSchemaRegistryEndpoint() throws IOException {
        // Create configuration map
        Map<String, Object> config = new HashMap<>();
    ...
    /**
     * Demonstrates how to configure an Avro serializer with a Secure Schema Registry endpoint without authentication.
     */
    public static void SerializeWithSecureSchemaRegistryEndpoint() throws IOException {
        // Create configuration map
        Map<String, Object> config = new HashMap<>();
    ...
    /**
     * Demonstrates how to configure an Avro serializer with an authenticated Secure Schema Registry endpoint.
     */
    public static void SerializeWithAuthenticatedSecureSchemaRegistryEndpoint() throws IOException {
        // Create configuration map
        Map<String, Object> config = new HashMap<>();
