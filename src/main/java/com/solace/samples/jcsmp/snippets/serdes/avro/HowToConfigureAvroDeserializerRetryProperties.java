 ...
 * </ul>
 */
public class HowToConfigureAvroDeserializerRetryProperties {
     ...
     */
    public static void ConfigureRequestAttempts() {
        ...
        try (AvroDeserializer<GenericRecord> deserializer = new AvroDeserializer<>()) {
            ...
            // At this point, the Avro deserializer is configured with the specified number of request attempts.
     ...
     */
    public static void ConfigureRequestAttemptBackoff() {
        // Create configuration map
        Map<String, Object> config = new HashMap<>();
        ...
        try (AvroDeserializer<GenericRecord> deserializer = new AvroDeserializer<>()) {
            ...
            // At this point, the Avro deserializer is configured with the specified backoff time.
     ...
     */
    public static void ConfigureCompleteRetryStrategy() {
        // Create configuration map
        Map<String, Object> config = new HashMap<>();
        ...
        try (AvroDeserializer<GenericRecord> deserializer = new AvroDeserializer<>()) {
            ...
            // At this point, the Avro deserializer is configured with a complete retry strategy:
