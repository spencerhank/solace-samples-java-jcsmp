 ...
 * <ul>
 *   <li>Configuring a pre-defined strategy (e.g. DestinationIdStrategy, SolaceTopicIdStrategy) using a Class object</li>
 ...
 * </ul>
 */
public class HowToConfigureJsonSchemaSerializerArtifactResolverStrategy {

    /**
     * Demonstrates how to configure a JSON Schema serializer using {@link DestinationIdStrategy} Class object.
    ...
    /**
     * Demonstrates how to configure a JSON Schema serializer using {@link SolaceTopicIdStrategy} Class object.
    ...
    public static void createSolaceTopicArtifactMappingWithTopicExpressionOnly(SolaceTopicProfile profile) {
        ...
        SolaceTopicArtifactMapping mapping1 = SolaceTopicArtifactMapping.create("solace/samples/jsonschema");
        // this generates an ArtifactReference with:
        //      group id: 'default', accessible with mapping1.getArtifactReference().getGroupId()
        //      artifact id: 'solace/samples/jsonschema' accessible with mapping1.getArtifactReference().getArtifactId()

        // create mapping with single level wildcard '*'
        SolaceTopicArtifactMapping mapping2 = SolaceTopicArtifactMapping.create("solace/*/sample/jsonschema");
        // this generates an ArtifactReference with:
        //      group id: 'default', accessible with mapping2.getArtifactReference().getGroupId()
        //      artifact id: 'solace/*/sample/jsonschema' accessible with mapping2.getArtifactReference().getArtifactId()
    ...
    public static void createSolaceTopicArtifactMappingWithTopicExpressionAndArtifactId(SolaceTopicProfile profile) {
        ...
        SolaceTopicArtifactMapping mapping1 = SolaceTopicArtifactMapping.create("solace/samples/jsonschema", "User");
        // this generates an ArtifactReference with:
        //      group id: 'default', accessible with mapping1.getArtifactReference().getGroupId()
        ...
        SolaceTopicArtifactMapping mapping2 = SolaceTopicArtifactMapping.create("solace/*/sample/jsonschema", "NewUser");
        // this generates an ArtifactReference with:
        //      group id: 'default', accessible with mapping2.getArtifactReference().getGroupId()
    ...
    public static void createSolaceTopicArtifactMappingWithTopicExpressionAndArtifactReference(SolaceTopicProfile profile) {
        ...
        SolaceTopicArtifactMapping mapping1 = SolaceTopicArtifactMapping.create("solace/samples/jsonschema", reference);
        // this generates an ArtifactReference with:
        //      group id: 'com.solace.samples.serdes.jsonschema.schema', accessible with mapping1.getArtifactReference().getGroupId()
        //      artifact id: 'User' accessible with mapping1.getArtifactReference().getArtifactId()
        ...
        SolaceTopicArtifactMapping mapping2 = SolaceTopicArtifactMapping.create("solace/*/sample/jsonschema", reference);
        // this generates an ArtifactReference with:
        //      group id: 'com.solace.samples.serdes.jsonschema.schema', accessible with mapping2.getArtifactReference().getGroupId()
        //      artifact id: 'NewUser' accessible with mapping2.getArtifactReference().getArtifactId()
     ...
     * <ul>
     *     <li>{@link HowToConfigureJsonSchemaSerializerArtifactResolverStrategy#createSolaceTopicArtifactMappingWithTopicExpressionOnly(SolaceTopicProfile)}</li>
     *     <li>{@link HowToConfigureJsonSchemaSerializerArtifactResolverStrategy#createSolaceTopicArtifactMappingWithTopicExpressionAndArtifactId(SolaceTopicProfile)}</li>
     *     <li>{@link HowToConfigureJsonSchemaSerializerArtifactResolverStrategy#createSolaceTopicArtifactMappingWithTopicExpressionAndArtifactReference(SolaceTopicProfile)}</li>
     *     <li>{@link HowToConfigureJsonSchemaSerializerArtifactResolverStrategy#modifySolaceTopicProfileWithAdd(SolaceTopicProfile, SolaceTopicArtifactMapping)}</li>
     * </ul>
     */
    public static void SerializeWithSolaceTopicIdStrategyWithProfile() throws IOException {
        ...
        try (Serializer<JsonNode> serializer = new JsonSchemaSerializer<>()) {
            ...
            // Note: order matters for topic profiles as 'solace/>' can also match 'solace/samples/jsonschema' however as
    ...
    /**
     * Demonstrates how to configure a JSON Schema serializer with a custom ArtifactReferenceResolverStrategy
    ...
    public static void SerializeWithCustomArtifactResolverStrategyUsingClassName() throws IOException {
        ...
        // For instance: "com.solace.sample.snippets.jsonschema.HowToConfigureJsonSchemaSerializerArtifactResolverStrategy$CustomArtifactReferenceResolverStrategy"
        // NOTE: The ArtifactReferenceResolverStrategy must have parameterless constructor
