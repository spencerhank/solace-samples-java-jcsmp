 ...
 * </ul>
 */
public class HowToConfigureAvroSerializerCacheProperties {

    /**
     * Demonstrates how to configure the cache TTL (time-to-live) property in milliseconds for an Avro serializer.
    ...
    public static void SerializeWithCacheTTL() throws IOException {
        ...
        try (Serializer<GenericRecord> serializer = new AvroSerializer<>()) {
            ...
            // At this point, the Avro serializer is configured with the specified cache TTL.
    ...
    /**
     * Demonstrates how to configure the use-cached-on-error property for an Avro serializer.
    ...
    public static void SerializeWithUseCachedOnError() throws IOException {
        ...
        try (Serializer<GenericRecord> serializer = new AvroSerializer<>()) {
            ...
            // At this point, the Avro serializer is configured with the specified use-cached-on-error property.
    ...
    /**
     * Demonstrates how to configure the cache-latest property for an Avro serializer.
    ...
    public static void SerializeWithCacheLatest() throws IOException {
        ...
        try (Serializer<GenericRecord> serializer = new AvroSerializer<>()) {
            ...
            // At this point, the Avro serializer is configured with the specified cache-latest property.
