 ...
 * </ul>
 */
public class HowToConfigureJsonSchemaDeserializerRetryProperties {
     ...
     */
    public static void ConfigureRequestAttempts() throws IOException {
     ...
     */
    public static void ConfigureRequestAttemptBackoff() throws IOException {
        // Create configuration map
        Map<String, Object> config = new HashMap<>();
     ...
     */
    public static void ConfigureCompleteRetryStrategy() throws IOException {
        // Create configuration map
        Map<String, Object> config = new HashMap<>();
