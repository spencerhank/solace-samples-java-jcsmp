 ...
 * </ul>
 */
public class HowToConfigureAvroSerializerRetryProperties {
    ...
    public static void SerializeWithRequestAttempts() throws IOException {
        ...
        try (Serializer<GenericRecord> serializer = new AvroSerializer<>()) {
            ...
            // At this point, the Avro serializer is configured with the specified number of request attempts.
    ...
    public static void SerializeWithRequestAttemptBackoff() throws IOException {
        ...
        try (Serializer<GenericRecord> serializer = new AvroSerializer<>()) {
            ...
            // At this point, the Avro serializer is configured with the specified backoff time.
    ...
    public static void SerializeWithCompleteRetryStrategy() throws IOException {
        ...
        try (Serializer<GenericRecord> serializer = new AvroSerializer<>()) {
            ...
            // At this point, the Avro serializer is configured with a complete retry strategy:
