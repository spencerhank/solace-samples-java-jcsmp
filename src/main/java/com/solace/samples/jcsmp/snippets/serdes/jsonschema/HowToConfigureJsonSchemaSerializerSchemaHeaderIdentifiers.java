...
/**
 * Provides code snippets demonstrating how to configure JSON Schema serializers with schema header identifiers.
 ...
 * </ul>
 */
public class HowToConfigureJsonSchemaSerializerSchemaHeaderIdentifiers {

    /**
     * Demonstrates how to configure a JSON Schema serializer to use the default schema header identifier {@link SchemaHeaderId#SCHEMA_ID SCHEMA_ID}.
     */
    ...
    /**
     * Demonstrates how to configure a JSON Schema serializer to use a single schema header identifier from a string.
    ...
    /**
     * Demonstrates how to configure a JSON Schema serializer to use a single schema header identifier from an enum.
    ...
    /**
     * Demonstrates how to configure a JSON Schema serializer to use multiple schema header identifiers.
