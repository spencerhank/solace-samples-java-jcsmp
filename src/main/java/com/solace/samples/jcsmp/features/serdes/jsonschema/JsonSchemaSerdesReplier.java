...
public class JsonSchemaSerdesReplier {
    ...
    /**
     * The main method that demonstrates the Solace JCSMP API usage with JsonSchema deserialization for Request-Reply.
     *
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 3) {
            System.out.printf("Usage: %s <host:port> <message-vpn> <client-username> [password]%n%n", JsonSchemaSerdesReplier.class.getName());
            System.exit(-1);
        }
        ...
        // Create and configure JsonSchema serializer for replies and deserializer for requests
        try (Serializer<CreateUserResponse> serializer = new JsonSchemaSerializer<>();
             Deserializer<CreateUser> deserializer = new JsonSchemaDeserializer<>()) {
            ...
            System.out.println("JsonSchemaSerdesReplier started. Waiting for requests ... Press enter to exit");
            System.in.read();
    ...
    static class RequestHandler {
        ...
        private final Serializer<CreateUserResponse> serializer;
         ...
         */
        public RequestHandler(XMLMessageProducer producer, Serializer<CreateUserResponse> serializer) {
         ...
         */
        public void handleRequest(BytesXMLMessage message, CreateUser createUserRequest) {
            try {
